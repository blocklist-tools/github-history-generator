...
# RiskAnalytics: Malware Domain Blocklist: 390cfeb8-2e4f-4a5c-9dd0-92dd63fc8a86
...
# 280blocker: Domain List 2390229f-a2ef-4788-be5a-e52c8991c0f2
...
docker-compose run --rm run --username blocklistproject --repo lists --name "a237508f-f0bf-4709-b626-67d2bbc801f8" "hosts_domains.txt"
